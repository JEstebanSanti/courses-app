...
export default function CourseItem({course}, children , props){
    return (

            <div className="max-w-sm p-3  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"  {...props}>
