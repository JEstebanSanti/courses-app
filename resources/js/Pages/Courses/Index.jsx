        ...
        >
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className='flex justify-evenly flex-wrap gap-3 py-2 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mt-3'>

                        {
                            courses.data.map((course) => (
                                <div className="max-w-sm p-3  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <div>
                                        <span class="bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full dark:bg-blue-900 dark:text-blue-300">{course.category_id.name}</span>
                                    </div>
